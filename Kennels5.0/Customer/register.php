          ...
          <div class="col-md-8 offset-md-2">
            ...
            <form method="post" action = "add_customer.php"><!--temp-->
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input name="first_name" type="text" class="form-control" placeholder="Ryan">
                </div>

                <label for="lastName" class="col-sm-3 col-form-label">Last Name</label>
                <div class="col-sm-9">
                  <input name="last_name" type="text" class="form-control" placeholder="Rodriguez">
                </div>

                <label for="password" class="col-sm-3 col-form-label">Password</label>
                <div class="col-sm-9">
                  <input name="password" type="password" class="form-control" placeholder="Metroid8">
                </div>

                <label for="phone" class="col-sm-3 col-form-label">Phone Number</label>
                <div class="col-sm-9">
                  <input name="phone_number" type="text" class="form-control" placeholder="931-257-4846">
                </div>

                <label for="email" class="col-sm-3 col-form-label">Email</label>
                <div class="col-sm-9">
                  <input name="email" type="email" class="form-control" placeholder="ragenplay@gmail.com">
                </div>

                <label for="street" class="col-sm-3 col-form-label">Address</label>
                <div class="col-sm-9">
                  <input name ="street" type="text" class="form-control" placeholder="1199 Viewmont Drive">
                </div>

                <label for="city" class="col-sm-3 col-form-label">City</label>
                <div class="col-sm-9">
                  <input name="city" type="text" class="form-control" placeholder="Clarksville">
                </div>
                ...
                <div class="col-sm-9">
                  <input name="zip" type="number" class="form-control" placeholder="37040">
                </div>
