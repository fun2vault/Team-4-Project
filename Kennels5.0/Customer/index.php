  ...
  <body>
    ...
    <div class="wrapper">
      ...
      <div class="container">
        ...
        <div class="card-deck">
          <div class="card">
            <a href="buy_dog.html"><img class="card-img-top" src="img/smalldog.jpg" alt="Standard Dog Kennel"></a>
            <a href="buy_dog.html"><div class="card-body">
              <h4 class="card-title">Standard Dog Kennel</h4>
              <h6 class="card-subtitle mb-2 text-muted">7x7x4</h6>
              <a href="buy_dog.html" class="card-link">$49.99</a>
            </div></a>
          </div>
          <div class="card">
            <a href="buy_dog_large.html"><img class="card-img-top" src="img/largedog.jpg" alt="Large Dog Kennel"></a>
            <a href="buy_dog_large.html"><div class="card-body">
              <h4 class="card-title">Large Dog Kennel</h4>
              <h6 class="card-subtitle mb-2 text-muted">10x10x6</h6>
              <a href="buy_dog_large.html" class="card-link">$79.99</a>

            </div></a>
          </div>
          <div class="card">
            <a href="buy_cat.html"><img class="card-img-top" src="img/smallcat.jpg" alt="Standard Cat Kennel"></a>
            <a href="buy_cat.html"><div class="card-body">
              <h4 class="card-title">Standard Cat Kennel</h4>
              <h6 class="card-subtitle mb-2 text-muted">3x3x3</h6>
              <a href="buy_cat.html" class="card-link">$39.99</a>
            </div></a>
          </div>
          <div class="card">
            <a href="buy_cat_large.html"><img class="card-img-top" src="img/largecat.jpg" alt="Large Cat Kennel"></a>
            <a href="buy_cat_large.html"><div class="card-body">
              <h4 class="card-title">Large Cat Kennel</h4>
              <h6 class="card-subtitle mb-2 text-muted">4x5x3</h6>
              <a href="buy_cat_large.html" class="card-link">$69.99</a>
            </div></a>
          </div>
        </div>
