  ...
  <body>
    ...
    <div class="wrapper">
      ...
      <div class="container" style="margin-bottom: 50px;">
        ...
        <div class="row">
          <div class="col-md-5">
            <div class="shop-image">
              <img src="img/largecat-large.jpeg">
            </div>
          </div>
          <div class="col-md-7">
             <h4>List Price: $<span id = "total">310</span>.00</h4>
				...
				<input type="button" id = "two_gate" onclick = "button_change('two_gate', 'one_gate', '30')" class="btn btn-outline-kennels" value = "Two +30.00"/>
				<div class="spacer"></div>
				<form method="get" action = "order.php">
			<input type="hidden" name="my_top" id="my_top" value="false">	
			<input type="hidden" name="my_bottom" id="my_bottom" value="false">	
			<input type="hidden" name="my_gate" id="my_gate" value="false">
        ...
        <div class="features">
          <p><span style="font-weight: bold;">Size</span><br>4' x 5' x 3'</p>
