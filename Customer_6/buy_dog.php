  ...
  <body>
    ...
    <div class="wrapper">
      <nav class="navbar navbar-toggleable-sm header">
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            ...
            <ul class="navbar-nav">
              <li class="nav-item">
                <a class="nav-link" href=""><h6>Welcome, <?php echo $_SESSION['cust_first_name'];?> </h6></a>
              </li>
			  <li class="nav-item">
      ...
      <div class="container" style="margin-bottom: 50px;">
		<br>
        <h2 class="shop-title">Standard Dog Kennel</h2>
        <div class="row">
          <div class="col-md-5">
			...
			<div class="col-md-7">
				<h4>List Price: $<span id = "total">315</span>.00</h4>
				...
				<input type="button" id = "two_gate" onclick = "button_change('two_gate', 'one_gate', '60')" class="btn btn-outline-kennels" value = "Two +60.00"/>
